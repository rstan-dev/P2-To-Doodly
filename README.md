...
The app was conceived in Balsamiq and then designed in Canva, and the final product is very close to the original design
   ...
   *  The main text font is Roboto from Google Fonts chosen for its easy readability, with sans-serif as a backup. 
   * Caveat Brush from google fonts was chosen as a fun header for the productivity area.
   ...
   * The minimum viable product was to have a functioning to-do list that could add an item, tick an item as done and delete the item.  
   * The items also needed to be saved to local storage so they would still be available when the app was reloaded.
...
The following tests were performed on the app:
  * W3C HTML validation - all tests passed.
  * <img src="assets/documents/HTML-validation.jpg">

  * W3C CSS Validation - displays 1 error relating to cdn.js library code, and 86 warnings relating to the same library code.  All over CSS was validated correctly
  * <img src="assets/documents/css-validation.jpg">
  ...
  * Mobile Responsive Test - performed on - https://ui.dev/amiresponsive
...
### Unresolved bugs:
  ...
  *  There are several warnings in the JSHInt validation relating to ES6 usagae.  I have decided to leave this as it is.
